			...
			<article>
				...
				<h1><span>Store<span class="u-rubyBottom u-pagetop">店舗一覧</span></span></h1>
					...
					<div class="c-wideBanner">
						<figure><img sizes="(max-width:375px), (min-width:768px)" srcset="{{ asset('/images/page-mv-store-s.jpg') }} 375w, {{ asset('/images/page-mv-store-l.jpg') }} 768w" src="{{ asset('/images/page-mv-store-s.jpg') }}" alt=""></figure>
					</div>
				</section>
				<div class="l-column__nallow u-paddingSideSP18">
					<ul class="p-shortList">
						<li>
							<h2>阪神梅田本店　6F　g-stage</h2>
						...
						<li>
							<h2>そごう横浜店　5Fメンズフロア内　g-stage</h2>
							<div class="u-flexHalf__PC">
								<dl>
									<div>
										<dt>Adress.</dt>
						...
						<li>
							<h2>ジェイアール京都伊勢丹　6F　レアセレクション内</h2>
							<div class="u-flexHalf__PC">
								<dl>
									<div>
										<dt>Adress.</dt>
				...
				<div class="c-wideBanner">
					<figure><img sizes="(max-width:375px), (min-width:768px)" srcset="{{ asset('/images/page-mv-store2-s.jpg') }} 375w, {{ asset('/images/page-mv-store2-l.jpg') }} 768w" src="{{ asset('/images/page-mv-store2-s.jpg') }}" alt=""></figure>
				</div>
			</article>
		</div>
	</main>
