        <div class="l-footer">
			<footer>
				<div class="l-columnRow">
					<a href="{{ route('top') }}" class="p-footerLogo"><figure><img src="{{ asset('images/logo-footer.png') }}" alt="G-Stage"></figure></a>
	...
	<script src="{{ asset('main.js?ver=1.0.5') }}"></script>
	<!-- validate -->
	<script src = "https://code.jquery.com/jquery-3.4.1.min.js"></script>
	<script src="http://parsleyjs.org/dist/parsley.js"></script>
	<script src="{{ asset('js/lib/jquery/colorbox/jquery.colorbox.js') }}"></script>
	<script src="{{ asset('/js/lib/jquery/colorbox/colorbox-func.js') }}"></script>
	<script src="{{ asset('/js/lib/jquery/fade/fade.js') }}"></script>
