			...
			<div class="l-column__nallow u-paddingSideSP18">
				<section class="l-section">
					...
					<ul class="c-tile c-halfSP">
						...
						for (var i=1; i<=12; i++) {
							tile.insertAdjacentHTML('beforeend', '<li class="c-fadeInImage"><a href="/g-stage/images/gallipoli-coordination'+i+'-l.jpg" class="cboxGroup is-fadeInImg is-'+i+'s"><figure><img sizes="(max-width:375px), (min-width:768px)" srcset="/g-stage/images/gallipoli-coordination'+i+'-s.jpg 375w, /g-stage/images/gallipoli-coordination'+i+'-l.jpg 768w" src="/g-stage/images/gallipoli-coordination'+i+'-s.jpg" alt="coordination'+i+'"></figure></a></li>');
						}
						</script>
					</ul>
				</section>
